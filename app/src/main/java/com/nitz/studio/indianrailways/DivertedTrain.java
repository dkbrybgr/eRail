...
/**
 * Created by nitinpoddar on 11/15/15.
 */
public class DivertedTrain extends ActionBarActivity{
    ...
    public class MyWebClient extends WebViewClient{
        ...
        public void onPageFinished(WebView view, String url) {
            webView.loadUrl("javascript:document.querySelectorAll('input[value=\"Diverted Trains\"]')[0].click();");
            // TODO Auto-generated method stub
